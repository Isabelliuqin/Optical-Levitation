...
builtinx=TQ.Fx_total(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P, target = "reflective")[0] * 10 ** 12,

builintime = time.time() - start_timeb
...
builtiny = TQ.Fy_total(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P, target = "reflective")[0] * 10 ** 12
...
start_time = time.time()
manual = TQ.F_total_manual_integration(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P, target = "reflective", coordinate = 'y', grid_size = 400)
end_time = time.time()
print (end_time - start_time) 
'''
...
builtinz = TQ.Fz_total(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P, target = "reflective")[0] * 10 ** 12
