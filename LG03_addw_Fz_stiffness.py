# -*- coding: utf-8 -*-
"""
Created on Mon Aug 31 16:31:25 2020
...
import Module_LG03_Fz_stiffness_at_parameter as FTAPz
import Module_LG03_Fx_stiffness_at_parameter as FTAPx
...
w_0 = np.linspace(0.5*10**(-6), 2*10**(-6),1000)
