# -*- coding: utf-8 -*-
"""
Created on Mon Aug 31 16:26:41 2020
...
###################
    # my new funcs
##################
def LG_03_Intensity_sphere_coordinate(theta, phi, rho_0x, rho_0y, rho, w, n_0, P):
    ...
    return ( P / ( 3 * np.pi * w ** 2))* (8 *r**6 / (w ** 6)) *  np.exp(- 2 * r**2 / w**2)
...
def Fz_integrand_Roosen(theta,phi, rho_0x,rho_0y, rho, n_0, n_s, w_0, w, z_R, P, target):
    ...
    I = LG_03_Intensity_sphere_coordinate(theta, phi, rho_0x, rho_0y, rho, wnew, n_0, P)   # beam intensity
...
def F_total_manual_integration(rho_0x,rho_0y, rho, n_0, n_s, w_0, w, z_R, P, target, coordinate, grid_size = 500):
    ...
    I = LG_03_Intensity_sphere_coordinate(theta, phi, rho_0x, rho_0y, rho, w, n_0, P)
