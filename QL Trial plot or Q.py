...
Axial_flist_vs_d0 =  np.asarray(TQ.Fz_total_vs_d_plot(rho_0[0][0],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P, target = "reflective"))
...
Axial_flist_vs_d1 =  np.asarray(TQ.Fz_total_vs_d_plot(rho_0[0][1],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P, target = "reflective"))


Q_z1 = Axial_flist_vs_d1 * c / ( n_0 * P )

Axial_flist_vs_d2 =  np.asarray(TQ.Fz_total_vs_d_plot(rho_0[0][2],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P, target = "reflective"))
Q_z2 = Axial_flist_vs_d2 * c / ( n_0 * P )
Axial_flist_vs_d3 =  np.asarray(TQ.Fz_total_vs_d_plot(rho_0[0][3],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P, target = "reflective"))
...
Axial_flist_vs_d0 =  np.asarray(TQ.Fz_total_vs_d_plot(rho_0[0],rho_0[1], rho[0], n_0, n_s, w_0, w, z_R, P, target = "reflective"))
...
Axial_flist_vs_d1 =  np.asarray(TQ.Fz_total_vs_d_plot(rho_0[0],rho_0[1], rho[1], n_0, n_s, w_0, w, z_R, P, target = "reflective"))


Q_z1 = Axial_flist_vs_d1 * c / ( n_0 * P )

Axial_flist_vs_d2 =  np.asarray(TQ.Fz_total_vs_d_plot(rho_0[0],rho_0[1], rho[2], n_0, n_s, w_0, w, z_R, P, target = "reflective"))
Q_z2 = Axial_flist_vs_d2 * c / ( n_0 * P )
Axial_flist_vs_d3 =  np.asarray(TQ.Fz_total_vs_d_plot(rho_0[0],rho_0[1], rho[3], n_0, n_s, w_0, w, z_R, P, target = "reflective"))
Q_z3 = Axial_flist_vs_d3 * c / ( n_0 * P )
...
Axial_flist_vs_d =  np.asarray(TQ.Fz_total_vs_rho0x_plot(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P, target = "reflective"))
...
Axial_flist_vs_Rs =  np.asarray(TQ.Fz_total_vs_Rs_plot(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P, target = "reflective"))
...
radial_flistx = np.asarray(TQ.Fx_total_vs_d_plot(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P, target = "reflective"))
...
radial_flistx0 = np.asarray(TQ.Fx_total_vs_rho0x_plot(rho_0[0],rho_0[1], rho[0], n_0, n_s, w_0, w, z_R, P, target = "reflective"))

Q_x0 = radial_flistx0 * c / ( n_0 * P )


radial_flistx1 = np.asarray(TQ.Fx_total_vs_rho0x_plot(rho_0[0],rho_0[1], rho[1], n_0, n_s, w_0, w, z_R, P, target = "reflective"))

Q_x1 = radial_flistx1* c / ( n_0 * P )

radial_flistx2 = np.asarray(TQ.Fx_total_vs_rho0x_plot(rho_0[0],rho_0[1], rho[2], n_0, n_s, w_0, w, z_R, P, target = "reflective"))
...
radial_flistx = np.asarray(TQ.Fx_total_vs_Rs_plot(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P, target = "reflective"))
...
radial_flisty = np.asarray(TQ.Fy_total_vs_d_plot(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P, target = "reflective"))
...
radial_flisty0 = np.asarray(TQ.Fy_total_vs_rho0y_plot(rho_0[0],rho_0[1], rho[0], n_0, n_s, w_0, w, z_R, P, target = "reflective"))

Q_y0 = radial_flisty0 * c / ( n_0 * P )


radial_flisty1 = np.asarray(TQ.Fy_total_vs_rho0y_plot(rho_0[0],rho_0[1], rho[1], n_0, n_s, w_0, w, z_R, P, target = "reflective"))

Q_y1 = radial_flisty1* c / ( n_0 * P )

radial_flisty2 = np.asarray(TQ.Fy_total_vs_rho0y_plot(rho_0[0],rho_0[1], rho[2], n_0, n_s, w_0, w, z_R, P, target = "reflective"))
...
radial_flisty0 = np.asarray(TQ.Fy_total_vs_rho0y_plot(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w[0], z_R, P, target = "reflective"))

Q_y0 = radial_flisty0 * c / ( n_0 * P )


radial_flisty1 = np.asarray(TQ.Fy_total_vs_rho0y_plot(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w[1], z_R, P, target = "reflective"))

Q_y1 = radial_flisty1* c / ( n_0 * P )

radial_flisty2 = np.asarray(TQ.Fy_total_vs_rho0y_plot(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w[2], z_R, P, target = "reflective"))
...
radial_flisty = np.asarray(TQ.Fy_total_vs_Rs_plot(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P, target = "reflective"))
...
radial_flistx = np.asarray(TQ.Fx_total_vs_rho0x_plot(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P))
...
radial_flisty = np.asarray(TQ.Fy_total_vs_Rs_plot(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P))
...
radial_flisty0 = np.asarray(TQ.Fy_total_vs_rho0y_plot(rho_0[0],rho_0[1],rho[0], n_0, n_s, w_0, w, z_R, P))

Q_y0 = radial_flisty0 * c / ( n_0 * P )


radial_flisty1 = np.asarray(TQ.Fy_total_vs_rho0y_plot(rho_0[0],rho_0[1],rho[1], n_0, n_s, w_0, w, z_R, P))

Q_y1 = radial_flisty1* c / ( n_0 * P )

radial_flisty2 = np.asarray(TQ.Fy_total_vs_rho0y_plot(rho_0[0],rho_0[1],rho[2], n_0, n_s, w_0, w, z_R, P))

Q_y2 = radial_flisty2 * c / ( n_0 * P )


radial_flisty3 = np.asarray(TQ.Fy_total_vs_rho0y_plot(rho_0[0],rho_0[1],rho[3], n_0, n_s, w_0, w, z_R, P))

Q_y3 = radial_flisty3 * c / ( n_0 * P )

radial_flisty4 = np.asarray(TQ.Fy_total_vs_rho0y_plot(rho_0[0],rho_0[1],rho[4], n_0, n_s, w_0, w, z_R, P))
...
Fz = np.asarray(TQ.Fz_total_vs_Rs_plot(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P, target = "reflective"))

Q_z = Fz * c / ( n_0 * P )


Fy = np.asarray(TQ.Fy_total_vs_Rs_plot(rho_0[0],rho_0[1],rho, n_0, n_s, w_0, w, z_R, P, target= "reflective"))

Q_y = Fy* c / ( n_0 * P )

Fx = np.asarray(TQ.Fx_total_vs_Rs_plot(rho_0[0],rho_0[1], rho, n_0, n_s, w_0, w, z_R, P, target = "reflective"))
