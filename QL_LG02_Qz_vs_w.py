# -*- coding: utf-8 -*-
"""
Created on Tue Aug 25 21:02:39 2020
...
w = np.linspace(w_0, 1.5*rho, 500)#np.linspace(w_0, 7*rho, 100)
...
MTP.table_parameter('x-axis w0 to 1.5*sqrt(2)rho', 'related to w', '0','see legend', '30')
