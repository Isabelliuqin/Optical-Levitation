# -*- coding: utf-8 -*-
"""
Created on Mon Aug 31 16:37:29 2020
...
import Module_LG03_Fz_stiffness_at_parameter as MFSAP
...
#w = [0.65*np.sqrt(2/3) *rho, 0.675* np.sqrt(2/3) *rho, 0.7* np.sqrt(2/3) *rho, 0.725* np.sqrt(2/3) *rho, 0.75* np.sqrt(2/3) *rho, 0.775* np.sqrt(2/3) *rho, 0.8* np.sqrt(2/3) *rho]
w = [w_0, 0.25* np.sqrt(2/3) *rho, 0.5 * np.sqrt(2/3) *rho, 0.75* np.sqrt(2/3) *rho, np.sqrt(2/3) *rho, 1.25*np.sqrt(2/3) *rho, 2*np.sqrt(2/3) *rho]

rho_00 = np.linspace(-3*np.sqrt(3/2)*w[0], 3*np.sqrt(3/2)*w[0], 100)

rho_01 = np.linspace(-3*np.sqrt(3/2)*w[1], 3*np.sqrt(3/2)*w[1], 100)

rho_02 = np.linspace(-3*np.sqrt(3/2)*w[2], 3*np.sqrt(3/2)*w[2], 100)

rho_03 = np.linspace(-3*np.sqrt(3/2)*w[3], 3*np.sqrt(3/2)*w[3], 100)

rho_04 = np.linspace(-3*np.sqrt(3/2)*w[4], 3*np.sqrt(3/2)*w[4], 100)

rho_05 = np.linspace(-3*np.sqrt(3/2)*w[5], 3*np.sqrt(3/2)*w[5], 100)

rho_06 = np.linspace(-3*np.sqrt(3/2)*w[6], 3*np.sqrt(3/2)*w[6], 100)
...
plt.plot(rho_00 / (np.sqrt(3/2)*w[0]), Q_z0 , lw=2, c="c", label="w = w0")
plt.plot(rho_01 / (np.sqrt(3/2)* w[1]), Q_z1 , lw=2, c="r", label="sqrt(3/2)*w/rho = 0.25")
plt.plot(rho_02  / (np.sqrt(3/2)* w[2]), Q_z2 , lw=2, c="g", label="sqrt(3/2)*w/rho = 0.5")
plt.plot(rho_03  / (np.sqrt(3/2)* w[3]), Q_z3 , lw=2, c="y", label="sqrt(3/2)*w/rho = 0.75")
plt.plot(rho_04  / (np.sqrt(3/2)* w[4]), Q_z4 , lw=2, c="b", label="sqrt(3/2)*w/rho = 1")
plt.plot(rho_05  / (np.sqrt(3/2)* w[5]), Q_z5 , lw=2, c="k", label="sqrt(3/2)*w/rho = 1.25")
plt.plot(rho_06  / (np.sqrt(3/2)* w[6]), Q_z6 , lw=2, c="m", label="sqrt(3/2)*w/rho = 2")



plt.plot(np.sqrt(2/3)*rho_00 / w[0], Q_z0 , lw=2, c="c", label="w/(sqrt(2/3) *rho) = 0.65")
plt.plot(np.sqrt(2/3)*rho_01 / w[1], Q_z1 , lw=2, c="r", label="w/(sqrt(2/3) *rho) = 0.675")
plt.plot(np.sqrt(2/3)*rho_02 / w[2], Q_z2 , lw=2, c="g", label="w/(sqrt(2/3) *rho) = 0.7")
plt.plot(np.sqrt(2/3)*rho_03 / w[3], Q_z3 , lw=2, c="y", label="w/(sqrt(2/3) *rho) = 0.725")
plt.plot(np.sqrt(2/3)*rho_04 / w[4], Q_z4 , lw=2, c="b", label="w/(sqrt(2/3) *rho) = 0.75")
plt.plot(np.sqrt(2/3)*rho_05 / w[5], Q_z5 , lw=2, c="k", label="w/(sqrt(2/3) *rho) = 0.775")
plt.plot(np.sqrt(2/3)*rho_06 / w[6], Q_z6 , lw=2, c="m", label="w/(sqrt(2/3) *rho) = 0.8")
...
plt.yticks(np.linspace(-2, 0, 6),fontsize=20)
...
######################################################
#coupling ratio at optimal w w0
######################################################

w_op = np.sqrt(2/3)*rho
Qmin = np.min(Q_z4)
...
w = np.linspace(0.4*np.sqrt(2/3)*rho, 2*np.sqrt(2/3)*rho, 50)
...
print(diffe)
print(w_minloc)
plt.plot((np.sqrt(3/2)*w/(rho)), ratio , lw=2, c="c", label="w = w_0")
...
w = np.linspace(0.6*np.sqrt(2/3) *rho, 1.5 * np.sqrt(2/3) *rho, 1000)

grad_Fzlist = []

for we in w:

    rho_0x_in = 0.5 *np.sqrt(3/2) * we
...
plt.figure(13)
plt.plot(np.sqrt(3/2)*w/rho, grad_Fzlist, lw=2, c="c", label="rho_0x/(sqrt(3/2)w) = 0.5")

print ((np.sqrt(3/2)*w/(rho))[np.argmin(abs(np.array(grad_Fzlist)))]) #print the inflection point

new_ticks1 = np.linspace(0.6, 1.5, 10) # plot axis
print(new_ticks1)
plt.xticks(new_ticks1,fontsize=20)
plt.yticks(np.linspace(-10, 10, 5),fontsize=20)
...
plt.xlabel('sqrt(3/2)w/rho',fontsize=20)
plt.ylabel('grad_Fz(10^(-8)N/m)',fontsize=20)
