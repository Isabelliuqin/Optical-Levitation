# -*- coding: utf-8 -*-
"""
Created on Mon Aug 31 13:08:04 2020
...
plt.figure(9)
plt.plot( w / (rho), Q_x0, lw=2, c="c", label="rho_0x/rho = 0.05")

plt.plot( w  / (rho), Q_x1, lw=2, c="r", label="rho_0x/rho = 0.25")

plt.plot( w  / (rho), Q_x2, lw=2, c="g", label="rho_0x/rho = 0.5")

plt.plot( w  / (rho), Q_x3, lw=2, c="y", label="rho_0x/rho = 0.75")

plt.plot( w  / (rho), Q_x4, lw=2, c="b", label="rho_0x/rho = 1")

plt.plot( w  / (rho), Q_x5, lw=2, c="k", label="rho_0x/rho = 1.25")

plt.plot( w  / (rho), Q_x6, lw=2, c="m", label="rho_0x/rho = 2")
...
##########################################################
#maximal allowable radial offset at optimal w, w0 and rho
##########################################################
